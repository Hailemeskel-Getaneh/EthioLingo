...
function LevelCompletScreen({ route, navigation }) {
  ...
  return (
    ...
    <View className="flex-1 bg-white  p-6">
      ...
      <View className="items-center justify-center p-8">
        ...
        <Text className="text-xl font-bold text-primaryBackground mt-4">
          {' '}
          You Complated
          {lessonTopic}
          Successfully!
        ...
        <Text className="text-l font-bold text-homeBackground mt-6">
          You unlock the next topic.in that topic you will learn
          {' '}
          {lessonNextTopic}
          {' '}
          in
