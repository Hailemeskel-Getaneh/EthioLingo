  ...
  return (
    <ScrollView className="flex-1 p-5 bg-white">
      ...
      <Text className="text-screenText1">
        ...
        {' '}
        We collect your name, email, and language preferences when you register.
        {'\n'}
        -
        <Text className="font-semibold">Usage Data:</Text>
        {' '}
        We track how you interact with the app to improve our services.
        {'\n'}
        -
        <Text className="font-semibold">Device Information:</Text>
        {' '}
        We may collect your device type, OS, and IP address for security purposes.
      </Text>
      ...
      <Text className="text-screenText1">
        - We
        {' '}
        <Text className="font-semibold ">do not</Text>
        {' '}
